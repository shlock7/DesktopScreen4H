...
#define EXAMPLE_MAX_STA_CONN       CONFIG_ESP_AP_MAX_STA_CONN  // 最大连接数量
...
void wifi_init_softap(void)
{
    ...
    wifi_config_t wifi_config = {
        .ap = {
            ...
            .authmode = WIFI_AUTH_WPA_WPA2_PSK  // 认证模式  WPA/WPA2 PSK模式
        },
    };
    // 如果密码为空 则将认证模式设置为开放
    ...
    ESP_ERROR_CHECK(esp_wifi_set_mode(WIFI_MODE_AP)); // 设置WiFi工作模式为SoftAP
    ESP_ERROR_CHECK(esp_wifi_set_config(WIFI_IF_AP, &wifi_config)); // 设置WiFi配置为SoftAP配置
