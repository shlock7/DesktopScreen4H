...
void ds_ui_timepage_show_time_init(){
    ...
    g_time_page.month = get_system_data().month;
    ...
    //月
    vertical = 100 + offset_v;
    num_size = 16;
    num_size_y = 24;
    horizontal = 70 + offset_h;
    //月 十位
    now_index = g_time_page.month / 10;
    ...
    // 月 汉字
    ds_screen_partial_data_add(horizontal+2*num_size,horizontal+3*num_size,vertical,vertical+num_size_y,gImage_word_size24[0]);

    //日
    vertical = 100 + offset_v;
    num_size = 16;
    num_size_y = 24;
    horizontal = 120 + offset_h;
    //日 十位
    now_index = g_time_page.day / 10;
    ds_screen_partial_data_add(horizontal,horizontal+num_size,vertical,vertical+num_size_y,gImage_num_size24[now_index]);
    //日 个位
    now_index = g_time_page.day % 10;
    ds_screen_partial_data_add(horizontal+num_size,horizontal+2*num_size,vertical,vertical+num_size_y,gImage_num_size24[now_index]);
    // 日 汉字
    ds_screen_partial_data_add(horizontal+2*num_size,horizontal+3*num_size,vertical,vertical+num_size_y,gImage_word_size24[1]);
    printf("********************** Year: %d **********************\n", g_time_page.year);
    printf("********************** Month: %d **********************\n", g_time_page.month);
    printf("********************** Day: %d **********************\n", g_time_page.day);
...
void ds_ui_timepage_init(){
    ...
    g_time_page.temperature = 20;
    g_time_page.humidity = 88;
    g_time_page.year = 1995;
    g_time_page.month = 6;
    g_time_page.day = 9;
}