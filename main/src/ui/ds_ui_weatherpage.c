...
void ds_ui_weather_show(uint8_t type){
    ...
    printf("***********************  ");
    printf("code:%d",g_weather_page.code);
    printf("  ***********************\n");
    if ((0 <= g_weather_page.code) && (g_weather_page.code <= 3))
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[0],288,48, WHITE, BLACK);
    else if((4 <= g_weather_page.code) && (g_weather_page.code <= 8))
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[1],288,48, WHITE, BLACK);
    else if((9 <= g_weather_page.code) && (g_weather_page.code <= 13))
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[2],288,48, WHITE, BLACK);
    else if((14 <= g_weather_page.code) && (g_weather_page.code <= 19))
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[3],288,48, WHITE, BLACK);
    else if((20 <= g_weather_page.code) && (g_weather_page.code <= 25))
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[6],288,48, WHITE, BLACK);
    else if(g_weather_page.code == 38)
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[0],288,48, WHITE, BLACK);
    else
        Paint_DrawString_piture(horizontal,vertical,gImage_num_weather_icon[1],288,48, WHITE, BLACK);
